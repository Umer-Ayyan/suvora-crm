...
const STATUS_TABS = [
  ...
  { key: "reviewing",   label: "Reviewing",    color: "#facc15" },
...
export default function ApplicationsPage() {
  ...
  async function downloadCV(id: string, fileName: string) {
    setDownloading(true);
    const res = await fetch(`/api/applications/${id}`);
    if (res.ok) {
          ...
          <div className="max-w-2xl mx-auto space-y-5">
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                {/* CV download */}
                <button onClick={() => downloadCV(selected.id, selected.cvFileName)} disabled={downloading}
